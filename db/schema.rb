...
ActiveRecord::Schema.define(:version => 20141114185316) do
  ...
  add_index "book_subjects", ["book_id", "subject_id"], :name => "index_book_subjects_on_book_id_and_subject_id", :unique => true
